/* 
kbd launch 1, fonctionne, mais à degraisser

todo:
- ajouter une commande pour killer kbdlnch type ''zzz''ou éventuellement depuis sys tray,
- faire lire le code de la touche dans le nom, ex: kbd222 = ascii 222
...
/* syntaxe due aux caracteres speciaux // et /" qui remplacent / et " */
 ...
 case 222 :{ShellExecute(0,0,"ConsoleExecute.exe",ParametresLigneDeCommande,NULL,SW_SHOWNORMAL); break;
	 }
